      ...
      <Card>
        ...
        <CardContent>
            <div className="prose prose-invert max-w-none">
                ...
                <p>
                Francis Legacy ("us", "we", or "our") operates the Francis Legacy website (the "Service"). This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data.
                </p>
